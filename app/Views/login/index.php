    ...
    <div class="panel panel-signin">
        <div class="panel-body">
            <div class="logo text-center">
                <h3>Компьютерный парк организаций образования Павлодарской области</h3>
            </div>
            <ul class="nav nav-tabs">
                <li class="active"><a href="#home" data-toggle="tab"><strong>Вход по логину</strong></a></li>
                <li><a href="#profile" data-toggle="tab"><strong>Вход по ID</strong></a></li>
            </ul>
